# Solution for Sensor Statistics Task

This task includes creating a command-line program that calculates statistics from humidity sensor data.

## How to run
```
➜  sbt stage
➜  ./target/universal/stage/bin/humidity-sensor-statistics-task src/test/resources/test-data         
```

### Task Background story
